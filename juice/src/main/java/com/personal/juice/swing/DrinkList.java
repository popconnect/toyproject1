...
public class DrinkList extends JFrame {
	...
	public DrinkList() {
		...
		scrollPane.setBounds(12, 89, 445, 425);
		contentPane.add(scrollPane);

		list = new JList<String>();
		scrollPane.setViewportView(list);
		
		JButton btnGoSurvey = new JButton("설문조사");
		btnGoSurvey.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				SurveyUserInterface dialog = new SurveyUserInterface();
		        dialog.setVisible(true);
			}
		});
		btnGoSurvey.setBounds(360, 524, 97, 23);
		contentPane.add(btnGoSurvey);
